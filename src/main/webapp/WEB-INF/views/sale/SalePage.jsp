        ...
        <nav class="navbar navbar-static-top">
            ...
            <div class="navbar-custom-menu">
                <ul class="nav navbar-nav">
                    <a type="button" class="btn btn-info" href="<%=request.getContextPath()%>/book/getAllBook">回到首页</a>
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <div class="box-body" style="display: block;">
                <form action="/book/sale" method="post" enctype="multipart/form-data" >
                    书名：<input name="bookName" />
                    <br/>
                    作者：<input name="author" />
                    <br/>
                    出版社：<input name="pubilshing" />
                    <br/>
                    总页数：<input name="totalPage" />
                    <br/>
                    总字数：<input name="wordNumber" />
                    <br/>
                    数量：<input name="bookNum" />
                    <br/>
                    单价：<input name="price" />
                    <br/>
                    图片：<input type="file" name="pic" multiple="multiple">
